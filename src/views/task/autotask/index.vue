        ...
        <div class="pushtask_table">
            ...
            <div class="vxe-table-div">
                <vxe-table border auto-resize height="auto" :column-config="{ resizable: true }"
                    ...
                    :scroll-y="{ enabled: false, gt: 0 }" :data="tableDataList" ref="tableRef"
                    ...
                    <vxe-column field="appId" title="app" show-header-overflow sortable align="center" width="5%"></vxe-column>
                    <vxe-column field="country" title="country" show-header-overflow sortable align="center" width="4%"></vxe-column>
                    <vxe-column field="offerId" title="offer" show-header-overflow sortable align="center" width="8%"></vxe-column>
